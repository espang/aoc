...
func main() {
	...
	case "day22":
		do("../inputs/input22.txt", day22.Part1, day22.Part2)
	case "day23":
		do("../inputs/input23.txt", day23.Part1, day23.Part2)
	case "day24":
		do("../inputs/input24.txt", day24.Part1, day24.Part2)
	case "day25":
		do("../inputs/input25.txt", day25.Part1, day25.Part2)
	default:
